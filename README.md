...
- [CRA + Progressive Web App goodness](https://github.com/jeffposnick/create-react-pwa/) - Progressive Web App template.
- [File API Input Layer](https://github.com/stoyan/fail) - File Upload Template
